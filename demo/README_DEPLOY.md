...
本目录是比赛演示薄前端。它只调用项目公开入口 `chat(user_text, thread_id)`，不复制或修改路线、画像、知识库、TourState 与导游路由。
...
如需使用项目当前的角色灰度配置，也仅在 Secrets/环境变量中设置，切勿写入前端页面或提交真实密钥。

## 比赛演示检查

- 新建会话，选择古风书生、30 分钟、灰塑，点击“生成我的路线”。
- 依次点击“我到前院中部了”“再讲详细一点”“完成本点”。
