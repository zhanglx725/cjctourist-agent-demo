...
| P3-05 | per-capability Graph rollout | each prior capability's tests and review | existing P2 rollout controls | narration-composition Shadow implemented; focused 23/23, Gate-related 39/39 and post-fix complete 906/906 passed; local API custom/repeat evidence accepted, pending Studio Trace review and remaining LangSmith matrix; all active takeover remains prohibited; see `p3_05_narration_shadow_handoff.md` |
